...
namespace azureAndroidTodo
{
	...
	public class ToDoActivity : Activity
	{
		...
		const string applicationURL = @"https://azureandroidtodo.azurewebsites.net";

		const string localDbFilename = "localstore.db";



		protected override async void OnCreate(Bundle bundles)
		{
			base.OnCreate(bundles);
			...
			//textNewToDo.SetImeActionLabel( , KeyEvent.KEYCODE_ENTER);
